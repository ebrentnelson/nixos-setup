  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      windowrulev2 = [
        ...
        "opacity 0.95 override 0.95 override, class:^(thunar)$"
        "opacity 0.95 override 0.95 override, class:^(com.mitchellh.ghostty)$"
      ];
      ...
      bind = [
        ...
        "$mainMod SHIFT, F, exec, $webapp='https://figma.com'"
